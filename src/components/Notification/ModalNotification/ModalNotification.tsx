...
export default function ModalProjectDetailOriginNotification() {
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex w-full gap-1  items-start">
                      ...
                      <p className="text-[24px] font-bold max-w-[250px] truncate">
                        {selectedNotification.projectUpdates?.project?.name}
                      </p>
                    </div>
                    <div className="flex items-center gap-3 ml-7">
                      ...
                      <Button className="bg-[#23CF5C] cursor-default p-0 px-4 h-7 text-[12px] dark:text-white">
                        {
                          selectedNotification.projectUpdates?.project
                            ?.listProjects?.name
                        }{" "}
                        <IoChevronDownSharp />
                      </Button>
                ...
                >
                  ...
                  <div
                    className={`flex pr-5 flex-col ${
                      selectedNotification.projectUpdates?.project?.description
                    ...
                    <div className="flex-col ml-7 mt-3">
                      {selectedNotification.projectUpdates?.project && (
                        <ProjectUpdateOriginNotification
                          project={selectedNotification.projectUpdates?.project}
                        />
                      )}
                    </div>
                  </div>
